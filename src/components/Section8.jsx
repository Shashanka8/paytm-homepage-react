...
function Section8() {
  return (
    <section class="relative pb-8 xl:pb-12" style={{ background: "#f5f7fa" }}>
      <div class="w-full xl:w-[1170px] m-auto relative bg-transparent rounded-[10px] z-[1]">
        <div class="flex flex-col-reverse md:flex-row-reverse items-center justify-between py-20">
          <div class="text-base font-bold w-full md:w-[50%] xl:w-[46%] mt-12 xl:mt-0 ml-2 xl:ml-0">
            ...
            <div class="mt-6 xl:mt-12 font-semibold text-4xl leading-[46px]">
              <div class="w-full xl:w-[390px] mt-6 xl:mt-12 font-bold text-3xl xl:text-[40px] xl:leading-[48px]">
          ...
          <img
            src={Image1}
            alt="money"
            class="w-full md:w-[400px] xl:w-[472px] z-[1]"
          />
        </div>
      </div>
      <img
        src={BGImage}
        alt="background"
        class="absolute left-0 bottom-0 h-full xl:h-[587px] w-full z-0"
      />
    </section>
  );
}
