...
function Section3() {
  return (
    <section
      class="pt-14 xl:pt-28 relative pb-8 xl:pb-12"
      style={{ background: "#f5f7fa" }}
    >
      <h1 class="mx-auto mb-6 xl:mb-9 font-bold text-4xl xl:text-5xl w-full xl:w-[1170px]">
        ...
        <div class="flex flex-col md:flex-row items-center justify-between p-2 xl:py-20 xl:pr-12 xl:pl-28">
          <div class="text-base font-bold w-full md:w-[50%] xl:w-[45%]">
            <div class="w-[175px] flex items-center">
              <img src={Image1} alt="wallet" class="h-[77px] w-auto pr-3" />
              Paytm Wallet
            </div>
