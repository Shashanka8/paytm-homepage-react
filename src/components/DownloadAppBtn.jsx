...
function DownloadAppBtn({ text }) {
  return (
    <div className="group flex justify-center items-center text-[15px] px-4 h-11 bg-black text-white font-medium border border-black rounded-3xl w-fit hover:text-black hover:bg-white cursor-pointer ml-2 xl:ml-0">
      {text}
